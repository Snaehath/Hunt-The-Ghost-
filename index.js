...
const cardObjectDefinitions = [
    { id: 1, imagePath: '/Image/price.png' },
    { id: 2, imagePath: '/Image/gas.png' },
    { id: 3, imagePath: '/Image/soap.png' },
    { id: 4, imagePath: '/Image/ghost.png' }
]
const aceId = 4
...
function shuffleCards() {
    ...
    function shuffle() {
        ...
        if (shuffleCount == 500) {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "click the card that you think is the Ghost")
